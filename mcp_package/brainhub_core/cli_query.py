"""Text rendering helpers for BrainHub query and graph CLI commands."""
...
def render_query_text(
    ...
    *,
    ...
    if not payload.get("found"):
        lines = [f"No BrainHub context found for: {query_text}"]
    ...
    lines = [f"BrainHub context packet: {payload['query']}"]
