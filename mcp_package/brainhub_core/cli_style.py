"""TTY-only styling for BrainHub's human CLI output."""
...
def style_cli_text(text: str, *, stream: TextIO | None = None) -> str:
    ...
    for line in text.splitlines():
        ...
        if not stripped:
            styled.append(line)
        elif re.match(r"^(BrainHub|No BrainHub)\b", stripped):
            ...
            styled.append(_wrap(line, YELLOW))
        elif stripped.startswith(("bh ", "python3 ", "py ", "brew ", "bash ", "http://", "https://")):
